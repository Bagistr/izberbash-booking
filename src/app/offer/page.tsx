        ...
        <div className="bg-white p-6 sm:p-12 rounded-3xl border border-slate-200 shadow-sm space-y-8">
          ...
          <div className="prose prose-slate max-w-none text-xs sm:text-sm leading-relaxed text-slate-700 space-y-6">
            ...
            <section className="space-y-2">
              ...
              <p><strong>Сервис (Платформа)</strong> — программный комплекс Сайта, позволяющий выбирать, бронировать и оплачивать услуги временного проживания[cite: 2].</p>
            ...
            <section className="space-y-2">
              ...
              <p>
                4.1. Оплата бронирования осуществляется в безналичном порядке через авторизованного платежного агрегатора Robokassa с использованием защищенных протоколов[cite: 2].
              </p>
              <p>
            ...
            <div className="p-6 bg-slate-50 rounded-2xl border border-slate-200 space-y-2 text-xs">
              ...
              <p><strong>Индивидуальный предприниматель:</strong> Джабраилов Багаудин Казимагомедович[cite: 2]</p>
