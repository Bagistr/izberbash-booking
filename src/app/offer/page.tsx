...
import { Waves, ArrowLeft, ShieldCheck, FileText, CheckCircle } from 'lucide-react';
          ...
          <div className="prose prose-slate max-w-none text-xs sm:text-sm leading-relaxed text-slate-700 space-y-6">
            ...
            <section className="space-y-2">
              ...
              <ul className="list-disc pl-5 space-y-1">
                <li>оформление заказа и онлайн-оплата обеспечительного платежа (предоплаты/брони) на Сайте[cite: 2];</li>
                <li>регистрация учетной записи на Сайте[cite: 2].</li>
              </ul>
            </section>

            <section className="space-y-2">
              <h2 className="text-base font-bold text-slate-900 uppercase tracking-wide">2. Термины и определения</h2>
              <p><strong>Сервис (Платформа)</strong> — сайт в сети Интернет, позволяющий выбирать, бронировать и оплачивать услуги временного проживания[cite: 2].</p>
              <p><strong>Пользователь (Гость / Принципал)</strong> — дееспособное физическое лицо, осуществляющее поиск и бронирование объекта на Сайте[cite: 2].</p>
            ...
            <section className="space-y-2">
              ...
              <p>
                3.1. Агент обязуется по поручению Пользователя совершить комплекс действий по онлайн-бронированию выбранного Объекта у Владельца, а также обеспечить информационное и технологическое взаимодействие Сторон при совершении расчетов через платежную систему Robokassa[cite: 2].
              </p>
              <p>
                3.2. Права и обязанности по непосредственному оказанию услуг проживания (состояние жилья, заезд, правила пользования помещением) возникают напрямую между Пользователем и Владельцем Объекта[cite: 2].
              </p>
            </section>
            ...
            <section className="space-y-2">
              ...
              <p>
                4.1. Оплата бронирования осуществляется в безналичном порядке через платежного агрегатора Robokassa с использованием защищенных протоколов[cite: 2].
              </p>
              <p>
            ...
            <section className="space-y-2">
              ...
              <p>
                5.1. При отмене бронирования в установленный правилами Объекта срок бесплатной отмены сумма внесенной предоплаты подлежит возврату в полном объеме тем же способом, которым была совершена оплата[cite: 1].
              </p>
              <p>
                5.2. При несвоевременной отмене или незаезде Гостя внесенная сумма может быть удержана в качестве компенсации фактических расходов в соответствии с законодательством РФ[cite: 1].
              </p>
            </section>
            ...
            <section className="space-y-2">
              ...
              <p>
                Обработка персональных данных Пользователя осуществляется в строгом соответствии с требованиями Федерального закона от 27.07.2006 № 152-ФЗ «О персональных данных»[cite: 2].
              </p>
            </section>

            <div className="p-6 bg-slate-50 rounded-2xl border border-slate-200 space-y-2 text-xs">
              <h3 className="font-bold text-slate-900 uppercase tracking-wide">7. Реквизиты Исполнителя (Агента)[cite: 2]</h3>
              <p><strong>Исполнитель:</strong> Джабраилов Багаудин Казимагомедович[cite: 2]</p>
              <p><strong>ИНН:</strong> 056002553388[cite: 2]</p>
              <p><strong>ОГРНИП:</strong> 323050000010499[cite: 2]</p>
              <p><strong>Телефон:</strong> +7 (964) 571-46-06[cite: 2]</p>
              <p><strong>E-mail:</strong> Baga1071@yandex.ru[cite: 2]</p>
            </div>
